...
ARTIFACT_DIR = Path('/Users/jingzeng/.gemini/antigravity/brain/702e7105-c6fa-494e-898d-38ba8ed1e2e4')
...
COLORS = {
    "DSOCOL": "#2563EB",    # Royal Blue (Ours)
    "APSEA": "#64748B",     # Slate Gray
    "CMOCSO": "#0D9488",    # Teal
    "IMCMOEAD": "#94A3B8"   # Light Slate
}
