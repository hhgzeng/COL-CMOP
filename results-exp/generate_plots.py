...
results_dir = Path('/Users/jingzeng/Documents/xidian/COL-CMOP/results-exp')
artifact_dir = Path('/Users/jingzeng/.gemini/antigravity/brain/df1fef3e-7acc-41b8-9a79-e87b84451c87')
artifact_dir.mkdir(parents=True, exist_ok=True)

df = pd.read_csv(results_dir / 'full_stat_summary.csv')
...
colors = {
    "DSOCOL": "#3B82F6",    # Vibrant Blue
    "APSEA": "#94A3B8",     # Slate Grey
    "CMOCSO": "#CBD5E1",    # Light Slate Grey
    "IMCMOEAD": "#E2E8F0"   # Off white / Light grey
}
